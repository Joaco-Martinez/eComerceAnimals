...
function calculateOrderTotals({ cartItems, paymentMethod, coupon, }) {
    ...
    const transferDiscountValue = transferenciaDiscount > 0 ? +(productSubtotal * transferenciaDiscount / 100) : 0;
    const couponDiscountValue = coupon
        ? coupon.discountType === 'percentage'
            ...
            : coupon.discountType === 'fixed'
                ...
                : 0
        : 0;
    const shippingCost = (coupon === null || coupon === void 0 ? void 0 : coupon.discountType) === 'free_shipping' ? 0 : 15000;
