...
exports.generateTransferEmailForSellerTemplate = exports.generateOrderEmailForSellerTemplate = void 0;
const mjml_1 = __importDefault(require("mjml"));
const generateOrderEmailForSellerTemplate = (order) => {
    var _a;
    const itemsRows = order.items
      ...
      `).join('');
    const couponHtml = ((_a = order.couponDiscount) === null || _a === void 0 ? void 0 : _a.applied)
        ? `
    <tr>
...
exports.generateOrderEmailForSellerTemplate = generateOrderEmailForSellerTemplate;
const generateTransferEmailForSellerTemplate = (order) => {
    var _a, _b;
    const itemsRows = order.items
        .map(item => `
      <tr style="border-bottom:1px solid #ccc;">
...
exports.generateTransferEmailForSellerTemplate = generateTransferEmailForSellerTemplate;
