 ...
 */
router.get('/overview', authMiddlewares_1.authMiddleware, isAdmin_1.isAdmin, stats_Controller_1.getOverview);
/**
 * @swagger
 ...
 */
router.get('/pet-type-sales', authMiddlewares_1.authMiddleware, isAdmin_1.isAdmin, stats_Controller_1.getPetTypeSales);
/**
 * @swagger
 ...
 *         description: Error interno
 */
router.get('/top-categories', authMiddlewares_1.authMiddleware, isAdmin_1.isAdmin, stats_Controller_1.getTopCategories);
/**
 * @swagger
 ...
 *         description: Error interno
 */
router.get('/top-colors', authMiddlewares_1.authMiddleware, isAdmin_1.isAdmin, stats_Controller_1.getTopColors);
/**
 * @swagger
 ...
 *         description: Error interno
 */
router.get('/top-sizes', authMiddlewares_1.authMiddleware, isAdmin_1.isAdmin, stats_Controller_1.getTopSizes);
/**
 * @swagger
 ...
 *         description: Error interno
 */
router.get('/payment-methods', authMiddlewares_1.authMiddleware, isAdmin_1.isAdmin, stats_Controller_1.getPaymentMethods);
/**
 * @swagger
 ...
 *         description: Error interno
 */
router.get('/top-products', authMiddlewares_1.authMiddleware, isAdmin_1.isAdmin, stats_Controller_1.getTopProducts);
/**
 * @swagger
 ...
 *         description: Error interno
 */
router.get('/orders-by-status', authMiddlewares_1.authMiddleware, isAdmin_1.isAdmin, stats_Controller_1.getOrdersByStatus);
/**
 * @swagger
 ...
 *         description: Error interno del servidor
 */
router.post('/products/:id/view', stats_Controller_1.registerProductView);
/**
 * @swagger
 ...
 *         description: Error interno del servidor
 */
router.get('/unconverted-products', authMiddlewares_1.authMiddleware, isAdmin_1.isAdmin, stats_Controller_1.getUnconvertedProducts);
/**
 * @swagger
 ...
 *         description: Error interno del servidor
 */
router.get('/earnings/year/:year', authMiddlewares_1.authMiddleware, isAdmin_1.isAdmin, stats_Controller_1.getEarningsByYearController);
/**
 * @swagger
 ...
 *         description: Error interno del servidor
 */
router.get('/earnings/month/:year/:month', authMiddlewares_1.authMiddleware, isAdmin_1.isAdmin, stats_Controller_1.getEarningsByMonthController);
