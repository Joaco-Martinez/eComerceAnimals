  ...
  return (
    <div className="hidden md:flex w-full gap-6 mt-6 px-6">
      ...
      <Link
        ...
        className="flex-1 relative bg-[#e6e2d8] h-80 flex items-end justify-center overflow-hidden shadow-lg hover:scale-[1.02] transition"
      >
      ...
      <Link
        ...
        className="flex-1 relative bg-[#c4bfab] h-80 flex items-end justify-center overflow-hidden shadow-lg hover:scale-[1.02] transition"
      >
        <button className="absolute top-5 px-8 py-3 bg-white text-[#b2a58e] font-semibold text-xl rounded-full shadow">
          Gatos
        </button>
